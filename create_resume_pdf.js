...
async function generateResumePDF() {
    ...
    function addWrappedText(text, size = 9, font = fontRegular, color = rgb(0.2, 0.2, 0.25), indent = 0, lineGap = 12.5) {
    ...
    skillCategories.forEach(item => {
        ...
        const catWidth = fontBold.widthOfTextAtSize('• ' + item.cat + ' ', 9);
    ...
    currentY -= 14;
    addWrappedText('• Engineered an automated content creation workflow utilizing Generative AI prompt chains to produce platform-tailored social media captions (LinkedIn, Meta, X) and graphic concepts.', 8.8, fontRegular, rgb(0.25, 0.25, 0.3), 10, 12.5);
    addWrappedText('• Integrated structured JSON template parsing to organize digital assets automatically into publish-ready campaign folders, slashing manual production time by 90%.', 8.8, fontRegular, rgb(0.25, 0.25, 0.3), 10, 12.5);
    currentY -= 6;
    ...
    currentY -= 14;
    addWrappedText('• Developed and launched a fully responsive web portfolio (portfolio-website-79bw.onrender.com) showcasing campaigns, analytical skills, and web projects.', 8.8, fontRegular, rgb(0.25, 0.25, 0.3), 10, 12.5);
    addWrappedText('• Implemented technical SEO best practices, Open Graph meta structures, and mobile performance optimizations for maximum search visibility.', 8.8, fontRegular, rgb(0.25, 0.25, 0.3), 10, 12.5);
    currentY -= 8;
    ...
    currentY -= 13;
    addWrappedText('• Relevant Coursework: Business Communication, Marketing Management, Business Analytics, Financial Accounting, Commercial Law.', 8.8, fontRegular, rgb(0.3, 0.3, 0.35), 10, 12);
    currentY -= 8;

    // 5. CERTIFICATIONS & ACHIEVEMENTS
    drawSectionTitle('Certifications & Key Achievements');
    addWrappedText('• Digital Marketing & Generative AI Specialization: Comprehensive training in SEO, Google Ads, Meta Ads Manager, GA4 Analytics, and AI Prompt Engineering.', 8.8, fontRegular, rgb(0.25, 0.25, 0.3), 8, 12.5);
    addWrappedText('• Google Analytics (GA4) & Search Optimization Fundamentals: Certified expertise in performance tracking, keyword research, and conversion funnel optimization.', 8.8, fontRegular, rgb(0.25, 0.25, 0.3), 8, 12.5);
    addWrappedText('• Achievement: Built an automated AI content creation pipeline reducing manual campaign drafting time by 90%.', 8.8, fontRegular, rgb(0.25, 0.25, 0.3), 8, 12.5);
    addWrappedText('• Achievement: Successfully designed, SEO-optimized, and deployed a live professional web portfolio on Render with 100% mobile responsiveness.', 8.8, fontRegular, rgb(0.25, 0.25, 0.3), 8, 12.5);
    currentY -= 8;

    // 6. EXTRA-CURRICULAR & LANGUAGES
    drawSectionTitle('Extra-Curricular Activities & Languages');
    addWrappedText('• Extra-Curricular Activities: Coordinated academic seminars and student marketing workshops at Shri Harishchandra PG College; active member of online AI and digital marketing strategy forums.', 8.8, fontRegular, rgb(0.25, 0.25, 0.3), 8, 12.5);
    addWrappedText('• Languages Spoken: English (Professional Working Proficiency), Hindi (Native / Full Professional Proficiency).', 8.8, fontRegular, rgb(0.25, 0.25, 0.3), 8, 12.5);
    ...
    console.log('Successfully generated full-page height Digital Marketing Executive Resume PDF');
}
